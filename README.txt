...
Git video is used primarily so that it can be used as reference in case other people (e.g. people that make models) have a guide to get it to work too.
Playlist is used to replicate a simple base multiplayer setup. 
